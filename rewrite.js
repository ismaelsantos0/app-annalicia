const fs = require('fs');
const text = fs.readFileSync('src/app/App.tsx', 'utf-8');
const lines = text.split('\n');

// Keep everything before App() starts
const part1 = lines.slice(0, 79); 
// AdminDashboard starts at line 1008 (index 1007), so we slice from 1006 to keep the comments
const part2 = lines.slice(1006);
...
fs.writeFileSync('src/app/App.tsx', [...part1, newApp, ...part2].join('\\n'));
